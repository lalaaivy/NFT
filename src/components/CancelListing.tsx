...
const CONTRACT_PACKAGE_ID = "0xd5ab453ab59660c81667ccd71f5ad06bbe42a437dd18ce4613c9c6366986c819";
    ...
    <div className="max-w-md mx-auto p-6 bg-white rounded-lg shadow-md">
      {account ? (
        <div className="space-y-4">
          <h2 className="text-2xl font-bold text-gray-800">Cancel Listing</h2>
