...
const MARKETPLACE_PACKAGE_ID = "0xd5ab453ab59660c81667ccd71f5ad06bbe42a437dd18ce4613c9c6366986c819";
const MARKETPLACE_OBJECT_ID = "0x1b5ae503974864f2370414b01e6cab9605995daf562e3795e2fbcad3c61cf031";
      ...
      <div className="flex flex-col md:flex-row justify-between items-start md:items-center mb-6 gap-4">
        <div>
          ...
          <div className="flex items-center gap-2 mt-1">
            <span className="text-sm text-gray-600">{marketplaceStatus}</span>
            <span className="text-xs text-gray-400">
              (Object: {MARKETPLACE_OBJECT_ID.slice(0, 8)}...{MARKETPLACE_OBJECT_ID.slice(-6)})
            </span>
          </div>
          <div className="text-xs text-gray-500 mt-1">
            Package: {MARKETPLACE_PACKAGE_ID.slice(0, 8)}...{MARKETPLACE_PACKAGE_ID.slice(-6)}
          </div>
        </div>
