...
export const CONTRACT_PACKAGE_ID = "0xd5ab453ab59660c81667ccd71f5ad06bbe42a437dd18ce4613c9c6366986c819";
...
export const MARKET_OBJECT_ID = "0x1b5ae503974864f2370414b01e6cab9605995daf562e3795e2fbcad3c61cf031"; // Your marketplace object ID
  ...
  return (
    <div className="max-w-md mx-auto p-4 space-y-4">
      ...
      <div className="bg-gray-50 rounded-lg border p-3">
        <h3 className="font-semibold text-gray-800 mb-2">Contract Info</h3>
        <div className="text-xs text-gray-600 space-y-1">
          <div>Package: {CONTRACT_PACKAGE_ID.slice(0, 8)}...</div>
          <div>Marketplace: {MARKET_OBJECT_ID.slice(0, 8)}...</div>
          <div>Method: {CONTRACT_MODULE_METHOD.withdrawMarket}</div>
        </div>
      </div>

      {/* Fee Display */}
      <div className="bg-white rounded-lg border p-4">
        <h2 className="text-lg font-bold mb-3">Marketplace Fees</h2>
      ...
      <button
        ...
        disabled={loading}
        className="w-full bg-blue-500 text-white py-2 rounded hover:bg-blue-600 disabled:bg-gray-300 transition-colors"
      >
        Refresh
      </button>
    </div>
